...
* **强大** - 支持 **增强版** csv 格式,  
&emsp;&emsp;&emsp;&emsp;&emsp;允许在字段名之后声明字段类型 (比如 [![](https://img.shields.io/badge/name-:string-blue)]()),  
&emsp;&emsp;&emsp;&emsp;&emsp;已支持的字段类型: **bool, int, number, string, json, strings**  
&emsp;&emsp;&emsp;&emsp;&emsp;详见 "release/csvs/enhanced_format_text.csv"   
